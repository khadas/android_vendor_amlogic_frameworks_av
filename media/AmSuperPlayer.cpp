...
static bool isAmNuplayerSupport(char *type,int videos,int audios)
{
    ...
    if ((NULL != strstr(type, "mpegts"))
        ...
        || (NULL != strstr(type, "vp6"))
        || (NULL != strstr(type, "avi"))
        || (NULL != strstr(type, "asf"))
        || (NULL != strstr(type, "mjpeg"))
        || (NULL != strstr(type, "wmv"))
        || (NULL != strstr(type, "raw"))
        || (NULL != strstr(type, "mp3"))
        || (NULL != strstr(type, "aac"))
        || (NULL != strstr(type, "wma"))
        || (NULL != strstr(type, "pcm"))
