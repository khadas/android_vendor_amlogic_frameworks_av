...
// returns true if a new CC track is found
bool AmNuPlayer::CCDecoder::parseSEINalUnit(int64_t timeUs, const uint8_t *data, size_t size) {
...
// returns true if a new CC track is found
bool AmNuPlayer::CCDecoder::extractFromMPEGUserData(const sp<ABuffer> &accessUnit) {
...
// returns true if a new CC track is found
bool AmNuPlayer::CCDecoder::parseMPEGUserDataUnit(int64_t timeUs, const uint8_t *data, size_t size) {
...
// returns true if a new CC track is found
bool AmNuPlayer::CCDecoder::parseMPEGCCData(int64_t timeUs, const uint8_t *data, size_t size) {
    bool trackAdded = false;
...
// returns true if a new CC track is found
bool AmNuPlayer::CCDecoder::parseDTVCCPacket(int64_t timeUs, const uint8_t *data, size_t size) {
...
size_t AmNuPlayer::CCDecoder::getTrackIndex(
...
int32_t AmNuPlayer::CCDecoder::CCTrack::compare(const AmNuPlayer::CCDecoder::CCTrack& rhs) const {
    int32_t cmp = mTrackType - rhs.mTrackType;
    if (cmp != 0) return cmp;
    return mTrackChannel - rhs.mTrackChannel;
}

bool AmNuPlayer::CCDecoder::CCTrack::operator<(const AmNuPlayer::CCDecoder::CCTrack& rhs) const {
