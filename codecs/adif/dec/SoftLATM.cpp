...
SoftLATM::SoftLATM(
    ...
    : SimpleSoftOMXComponent(name, callbacks, appData, component),
      ...
      CHECK(!strcmp(name, "OMX.google.latm.decoder"));
    initPorts();
...
void SoftLATM::initPorts() {
    ...
    def.format.audio.cMIMEType =
        const_cast<char *>(MEDIA_MIMETYPE_AUDIO_AAC_LATM);
...
OMX_ERRORTYPE SoftLATM::internalGetParameter(
    ...
    switch (index) {
		case OMX_IndexParamAudioAac:
        {
            ...
            aacParams->eAACStreamFormat = OMX_AUDIO_AACStreamFormatMP4LATM;
...
OMX_ERRORTYPE SoftLATM::internalSetParameter(
...
bool SoftLATM::isConfigured() const {
    return mInputBufferCount > 0;
}

void SoftLATM::onQueueFilled(OMX_U32 portIndex) {
...
void SoftLATM::onPortEnableCompleted(OMX_U32 portIndex, bool enabled) {
    if (portIndex != 1) {
        return;
    }
...
android::SoftOMXComponent *createSoftOMXComponent(
    ...
    return new android::SoftLATM(name, callbacks, appData, component);
}
